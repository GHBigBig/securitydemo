...
public class ValidateController {
    ...
    /*
        ...
        包含了setAttribute、getAttribute和removeAttribute方法
    ...
    public void createSmsCode(HttpServletRequest request, HttpServletResponse response, String mobile)
        ...
        //通过SessionStrategy对象的setAttribute方法将短信验证码保存到了Session中，对应的key为SESSION_KEY_SMS_CODE+mobile
    ...
    public void createCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        imageCode.setImage(null);   //BufferedImage 无法序列存储也不需要
