package com.zjg.securitydemo.provider;

import com.zjg.securitydemo.token.SmsAuthenticationToken;
...
public class SmsAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (userDetails==null) {
            throw new InternalAuthenticationServiceException("此手机号为注册！");
        }
